...
/* commands */
static const char *up_vol[]   = { "sh", "-c", "wpctl set-volume @DEFAULT_SINK@ 5%+; pkill -RTMIN+3 someblocks", NULL };
static const char *down_vol[] = { "sh", "-c", "wpctl set-volume @DEFAULT_SINK@ 5%-; pkill -RTMIN+3 someblocks",   NULL };
...
static const Key keys[] = {
  ...
  { 0, XKB_KEY_XF86MonBrightnessDown,               spawn,            {.v = brightness_down}},
	...
	{ MODKEY,                    XKB_KEY_i,           focusdir,         {.ui = 1} },
	{ MODKEY,                    XKB_KEY_Up,          focusdir,         {.ui = 2} },
	{ MODKEY,                    XKB_KEY_e,           focusdir,         {.ui = 2} },
	{ MODKEY,                    XKB_KEY_Down,        focusdir,         {.ui = 3} },
	{ MODKEY,                    XKB_KEY_n,           focusdir,         {.ui = 3} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_Left,        swapdir,          {.ui = 0} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_m,           swapdir,          {.ui = 0} },
	...
	{ MODSHIFT,                  XKB_KEY_f,           togglefullscreen, {0} },
