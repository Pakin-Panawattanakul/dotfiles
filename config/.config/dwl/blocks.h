...
static const Block blocks[] = {
   ...
   {"", "for b in $(upower -e | grep BAT); do upower -i \"$b\"; done \
      | awk '/energy:/&&!/energy-empty/&&!/energy-full/{e+=$2} /energy-full:/&&!/energy-full-design/{f+=$2} END{p=(f>0)?(e/f*100):0; c=\"b3f6c0\"; if(p<=15)c=\"ffc0b9\"; else if(p<=30)c=\"fce094\"; printf \"^fg(%s)󰁹 %.0f%%^fg()\", c, p}'", 5, 0},
